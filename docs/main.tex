...
on the full feature set and reports model diagnostics without generating per-metric
probability plots. If \texttt{--model-type stepwise} is selected, the pipeline performs
forward feature selection to maximize ROC-AUC and reports the chosen features and
incremental AUC improvements.
